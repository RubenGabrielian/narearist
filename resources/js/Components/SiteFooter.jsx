                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                    <div>
                        <nav className="space-y-5">
                            ...
                            <a href="https://t.me/tennisacademynovel" className="block hover:text-yellow-200 transition-colors text-sm">
                                Քննարկումների սենյակ
                            </a>
                            <a href="/about-author#contact" className="block hover:text-yellow-200 transition-colors text-sm">
                                Կապ
                            </a>
                        </nav>
                    </div>
